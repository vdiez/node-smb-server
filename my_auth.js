...
var Authenticator = require('./lib/spi/authenticator');
var Session = require('./lib/spi/session');
...
/**
 * Creates an instance of MyAuthenticator.
 *
 * @constructor
 * @this {MyAuthenticator}
 */
var MyAuthenticator = function () {
    if (!(this instanceof MyAuthenticator)) {
...
// the MyAuthenticator prototype inherits from Authenticator
util.inherits(MyAuthenticator, Authenticator);

MyAuthenticator.prototype.authenticate = function (challenge, caseInsensitivePassword, caseSensitivePassword, domainName, accountName, cb) {
